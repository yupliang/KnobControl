...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/yupliang/KnobControl.git"
  ...
  s.author             = { "yupeiliang" => "yupeiliang@fotoable.com" }
  ...
  s.source       = { :git => "https://github.com/yupliang/KnobControl.git", :tag => "1.0.0" }
